...
module.exports = {
    vectorSpaceModel: async function () {
        ...
        /*
            ->array of arrays.
            ->each block of array will contain another array of length 56 containing term frequency
        ...
        */
                    ...
                    words.forEach(word => {
                        ...
                        if (!stopWords.includes(word) && !breakers.includes(word)) {
                            /*
                                ...
                                ->create an array of term frequencies having lenght 56 in which term 
                            ...
                            */
                            if (lexemes.get(word)== undefined) {
                                ...
                                let temptf = new Array(56).fill(0);
                                temptf[id - 1] = 1;
        ...
        let i = 0;
        var s = "speech_";
        //reading all the 56 files from the corpus..
        while (i <= 55) {
            let file = './dataset/'+ s + i + '.txt';//apending file name
    ...
    calculateNorms: async function(lexemes,tfDocuments,idf){
        ...
        let norm=0;
        let i=0;
        //iterate all documents form 1 to 56...
        while(i<56){
